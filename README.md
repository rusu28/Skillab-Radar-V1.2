...
- `results/figures/`: PNG figures for report and pitch
...
- `methodology_table.csv`: formulas and interpretation for report reviewers
- `results/submission_manifest.json`: generated files, commands, endpoints, and reproducibility metadata
...
- CSVs, PNG figures, report, pitch script, and manifest regenerated by one pipeline command
